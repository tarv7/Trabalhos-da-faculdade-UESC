...
*
* Descrição: Reescreva o programa anterior alocando memoria dinamicamente para a estrutura.
*
*
* Entrada: 
Thales
...
int main(){
	tAluno *p; // Ponteiro para manipular a Struct

	// Alocando memoria e verificando
	p = (tAluno *) malloc(sizeof(tAluno));;
	if(p == NULL)
		exit(-1);
